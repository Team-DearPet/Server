...
public class OrderController {
    ...
    public ResponseEntity<OrderDTO> cancelOrder(@PathVariable("order_id") Long orderId) {
    ...
    public ResponseEntity<List<OrderItemDTO>> getOrderItems(@PathVariable("order_id") Long orderId) {
